 ...
 */
int
xdrfile_compress_coord_float(float *ptr, int ncoord, float precision, XDRFILE *xfp);
 ...
 */
int
xdrfile_decompress_coord_float(float *ptr, int *ncoord, float *precision, XDRFILE *xfp);
 ...
 */
int
xdrfile_compress_coord_double(double *ptr, int ncoord, double precision, XDRFILE *xfp);
 ...
 */
int
xdrfile_decompress_coord_double(double *ptr, int *ncoord, double *precision, XDRFILE *xfp);
